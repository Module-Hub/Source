# Verse Library
This documentation is for the stable release of Verse Library.

# All credits to sirius 
This is for learning purposes and just for updating it


## Booting the Library
```lua
local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/Verse-Hub/Source/main/source')))()
```
...
## Creating a Window
```lua
local Window = OrionLib:MakeWindow({Name = "Title of the library", HidePremium = false, SaveConfig = true, ConfigFolder = "VerseTest"})
